...
<div style={{float:"left",marginTop:"30px"}}>
                   <div className="image"  >
            <img src="https://d3sujgifhk94se.cloudfront.net/wp-content/uploads/2019/12/09091747/kid_loves_coding.jpg" class="attachment-large size-large" alt="child" style={{height:"600px",marginTop:"-40px",float:"left",width:"500px",marginLeft:"10px" }} />
          </div></div> 
          <div style={{marginLeft:"650px",width:"720px",borderWidth:"2px",marginTop:"0px",borderRadius:"20px", boxShadow: "5px 10px 10px orange",fontFamily:"cursive",fontSize:"23px"}}>
