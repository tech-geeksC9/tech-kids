...
function DragNDrop({data}) {
  ...
  const history = useHistory();
    ...
    return (
      <div id= 'bbbbbb'>   
 <p  id='ididid'> ▶▶▶Hmm it seems like the following HTML Tags aren't in the right order, move the items from the Drag Bar and drop them in the right order inside the Drop bar◀◀◀</p>
<div className="drag-n-drop">
      ...
      {localStorage.getItem('List')===  '[{"title":"Drag","items":[]},{"title":"Drop here","items":["<!DOCTYPE html>","<html>","<body>","<p>My paragraph.</p>","<h1>My Heading</h1>","</body>","</html>"]}]' ||localStorage.getItem('List')===  '[{"title":"Drag","items":[]},{"title":"Drop here","items":["<!DOCTYPE html>","<html>","<body>","<h1>My Heading</h1>","<p>My paragraph.</p>","</body>","</html>"]}]'? <div>  
    ...
    <Modal show={show} onHide={handleClose}>
      ...
      <Modal.Footer>
        ...
        <Button variant="primary" onClick={()=>{history.push('/ex4HTML')}}> Go to the Next exersise </Button>
      </Modal.Footer>
    </Modal></div>:<div>  
         <Button variant="primary" onClick={handleShow}> SUBMIT </Button>
